        ...
        <div className="carousel-inner ">
          ...
          <div className="carousel-item active ">
            {/* <img
                  ...
                  /> */}
            <Image locationId="homeCou1" imgClassName="carousel-image"></Image>
          </div>

          <div className="carousel-item">
            <Image locationId="homeCou2" imgClassName="carousel-image"></Image>
          </div>
          <div className="carousel-item">
            <Image locationId="homeCou3" imgClassName="carousel-image"></Image>
          </div>
          <div className="carousel-item">
            <Image locationId="homeCou4" imgClassName="carousel-image"></Image>
          </div>
          <button
      ...
      <div className="container mt-5 intro">
        <div className="d-flex flex-column  ">
          <div className="col-12 ">
            ...
            <p id="intro">
              Conveniently situated at the heart of Avondale, adjacent to Fry's
              and Starbucks, we're thrilled to present a sanctuary devoted to
              enhancing beauty and providing relaxation for all your nail care
              necessities. Immerse yourself in our realm of indulgence and
              experience an extensive assortment of nail services personalized
              to match your distinct style and preferences. Our proficient nail
              technicians are dedicated to delivering unparalleled customer
              service and crafting astonishing nail art that will instill
              confidence and radiance within you. From timeless manicures and
              pedicures to fashionable nail designs and lavish spa therapies, we
              provide a comprehensive selection of offerings that employ
              high-quality products. Be it a swift touch-up or a complete
              makeover, our warm and welcoming ambiance serves as the ideal
              haven to unwind and pamper yourself with some well-earned
              "me-time."
            </p>
          </div>
