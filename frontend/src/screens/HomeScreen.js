      ...
      >
        <div className="carousel-inner d-flex align-items-center">
          ...
          <div className="carousel-item active">
            ...
            <Image
              locationId="homeCou1"
              imgClassName="d-block w-75 mx-auto my-auto"
            ></Image>
          </div>
        ...
        <div className="d-flex flex-column  ">
          <div className="col-12 ">
            ...
            <p id="intro">
              ...
              relaxation for all your nail care needs. Step into our world of
              pampering and indulge yourself with a wide array of nail services
              tailored to suit your unique style and preferences. Our team of
              skilled nail technicians is committed to providing exceptional
              customer service and creating stunning nail art that will leave
              you feeling confident and fabulous. From classic manicures and
              pedicures to trendy nail designs and luxurious spa treatments, we
              offer a comprehensive range of services using high-quality
              products. Whether you're looking for a quick touch-up or a
              complete transformation, our cozy and inviting atmosphere is the
              perfect place to unwind and treat yourself to some well-deserved
              "me-time."
            </p>
          </div>
          <div className="col-12">
            <Image locationId="home1" imgClassName="img-fluid mt-5"></Image>
